...
describe('Frank and Oak', () => {
    ...
    it('Testsuit4,addicon', () => {
     ...
     cy.xpath('(//button[text()="Quick Add"])[9]').click({force:true});
     cy.wait(3000)
    ...
    it('Testsuit5,checkout', () => {
        ...
        cy.get("#redirection-product").click()
        cy.wait(3000)
        cy.xpath('(//button[text()="Quick Add"])[9]').click();
        cy.go('back')
        cy.get('#cart-icon').click()
        cy.go('forward')
        //cy.get("#redirection-product").click()
    ...
    it('Testsuit6, verify all clickable icon', () => {
        ...
        cy.get('#close-icon-signup').click({force:true})
    });
    it('Testsuit7, verify all clickable icon in footer', () => {
      Cypress.on('uncaught:exception', (err, runnable) => {
        return false;
      });
      cy.visit('https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')
      ...
      cy.url().should('include','https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')//same page asserted


    });
    it('Testsuit8, verify intagram icon & other icon down to logo in footer', () => {
      Cypress.on('uncaught:exception', (err, runnable) => {
        return false;
      });
      cy.visit('https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')
      ...
      cy.scrollTo(0,5000)
      cy.wait(3000)
      cy.get('i[class="fa-brands fa-instagram"]').click()// moving to upward instead of instagram page
      cy.scrollTo(0,5000)
      cy.wait(2000)
      cy.get('i[class="fa-brands fa-facebook-f"]').click()//facebook similar to instagram
      cy.scrollTo(0,5000)
      cy.wait(2000)
      cy.get('i[class="fa-brands fa-twitter"]').click()//twitter
      cy.scrollTo(0,5000)
      cy.wait(2000)
      cy.get('i[class="fa-brands fa-pinterest-p"]').click()//pinterest

    });
    it('Testsuit9,Verify search functionality', () => {
      Cypress.on('uncaught:exception', (err, runnable) => {
        return false;
      });
      cy.visit('https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')
      ...
      cy.get('#close-icon-signup').click()
      cy.wait(2000)
      cy.get('#search-icon').click()//search icon open search box text field
      cy.wait(2000)
      cy.get('#search-container-input').type('Women',{force:true})//type able
      cy.wait(2000)
      cy.get('#search-icon-container').click({force:true})//search icon land to searchproduct page
      cy.get('#search-icon').click()
      cy.get('#search-container-input').type('luoiviton5',{force:true})//number typeable
      cy.wait(2000)
      cy.get('#search-icon-container').click({force:true})
      cy.get('#search-icon').click()
      cy.get('#search-container-input').type('$womenprinted',{force:true})//special character typeable
      cy.wait(2000)
      cy.get('#search-icon-container').click({force:true})
      cy.get('#search-container-input').trigger('mouseover',{force:true})//tooltip is available
      cy.url().should('include','https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')//same page [error]
      
    });
    it('Testsuit10,Verify wishlist functionality', () => {
      Cypress.on('uncaught:exception', (err, runnable) => {
        return false;
      });
      cy.visit('https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')
      ...
      cy.get('#signup-button').click({force:true}) 
      cy.get('#close-icon-signup').click()
      cy.get('#wish-list').click()//cickable
      cy.url().should('include','https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/wishlist')
        //led to blank page[blocker]
    });
    it('Testsuit11,Verify logout functionality', () => {
      Cypress.on('uncaught:exception', (err, runnable) => {
        return false;
      });
      cy.visit('https://6641c4a6f60fc17bdb89b7db--cheery-genie-3d5d23.netlify.app/')
